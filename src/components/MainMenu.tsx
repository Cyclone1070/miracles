        ...
        <div className="w-screen h-dvh relative overflow-hidden flex justify-center items-center p-2">
            ...
            <motion.div 
                ...
                <div className={`relative flex items-center`}>
                    ...
                    <ActionButton
                        className={`absolute -right-10 w-7 h-7 flex items-center justify-center bg-(--accent-under-text) rounded-full`}
                        onClick={() => {
                            setIsHelpVisible(true);
                        }}
                    >?</ActionButton>
                </div>
				<ActionButton className={`p-1.5 bg-(--accent-under-text)`}>Clear Data</ActionButton>
            </motion.div>
